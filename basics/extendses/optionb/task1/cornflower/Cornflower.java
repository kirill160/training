package basics.extendses.optionb.task1.cornflower;
...
public class Cornflower extends Flower {
    ...
    public Cornflower(TypeFlower typeFlower, int price, String nameFlower, int lengthStem) {
        super(typeFlower, price, nameFlower, lengthStem);
    ...
    public int getLengthStem() {
        return super.getLengthStem();
    }

    @Override
    public void setLengthStem(int lengthStem) {
        super.setLengthStem(lengthStem);
    }
